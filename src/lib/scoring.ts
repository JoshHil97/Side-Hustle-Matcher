...
const TASK_TO_SKILLS: Record<string, SkillTag[]> = {
  ...
  sql_querying: ["data_analysis", "analytical_thinking", "dashboarding"],
  ...
  cloud_infra_ops: ["cloud_platforms", "devops", "operations", "troubleshooting"],
  ci_cd_release_ops: ["ci_cd", "devops", "automation", "documentation"],
  incident_response: ["incident_management", "monitoring_observability", "troubleshooting", "communication"],
  iac_work: ["infrastructure_as_code", "cloud_platforms", "automation", "problem_solving"],
  python_scripting: ["coding", "automation", "data_analysis", "problem_solving"],
  data_cleaning_migration: ["data_analysis", "quality_assurance", "documentation", "spreadsheet_management"],
...
const TOOL_TO_SKILLS: Record<string, SkillTag[]> = {
  ...
  sql_platforms: ["data_analysis", "analytical_thinking", "dashboarding"],
  notebook_tools: ["data_analysis", "research", "documentation"],
  ...
  python_stack: ["coding", "automation", "data_analysis"],
  etl_tools: ["automation", "operations", "data_analysis"],
  cloud_platform_tools: ["cloud_platforms", "devops", "operations"],
  ci_cd_tools: ["ci_cd", "automation", "devops"],
  iac_tools: ["infrastructure_as_code", "devops", "automation"],
  container_tools: ["devops", "troubleshooting", "operations"],
  monitoring_tools: ["monitoring_observability", "incident_management", "analytical_thinking"],
...
const OUTPUT_TO_SKILLS: Record<string, SkillTag[]> = {
  ...
  sql_reporting_assets: ["data_analysis", "dashboarding", "presentation"],
  python_automation_scripts: ["coding", "automation", "problem_solving"],
  cleaned_datasets: ["data_analysis", "quality_assurance", "documentation"],
  cloud_env_deployments: ["cloud_platforms", "devops", "ci_cd", "documentation"],
  ci_cd_pipelines: ["ci_cd", "automation", "devops"],
  runbooks_postmortems: ["incident_management", "documentation", "monitoring_observability"],
  infra_modules: ["infrastructure_as_code", "automation", "cloud_platforms"],
